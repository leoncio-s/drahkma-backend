...
order by date desc;";
    ...
    public function getAmounts(string $start_date, string $finish_date, int $userId): array
    {
        ...
        $data['amount'] = $data['inflow'] - $data['outflow'];
    ...
    private function getOutAmounts(string $start_date, string $finish_date, int $userId):?float
    {
    ...
    private function getInAmounts(string $start_date, string $finish_date, int $userId):?float
    {
    ...
    private function getInAmountsByCategory(string $start_date, string $finish_date, int $userId):?array
    {
    ...
    private function getOutAmountsByCategory(string $start_date, string $finish_date, int $userId):?array
    {
    ...
    private function getInAmountsByCard(string $start_date, string $finish_date, int $userId):?array
    {
    ...
    private function getOutAmountsByCard(string $start_date, string $finish_date, int $userId): ?array
    {
    ...
    private function getInAmountsByTransferBankAccounts(string $start_date, string $finish_date, int $userId) :?array
    {
    ...
    private function getOutAmountsByTransferBankAccounts(string $start_date, string $finish_date, int $userId) : ?array
    {
    ...
    private function getInTotalAmmountByTransferBank(string $start_date, string $finish_date, int $userId) : ?float
    {
    ...
    private function getOutTotalAmmountByTransferBank(string $start_date, string $finish_date, int $userId) : ?float
    {
    ...
    private function getInTotalAmountsByCard(string $start_date, string $finish_date, int $userId) : ?float
    {
    ...
    private function getOutTotalAmountsByCard(string $start_date, string $finish_date, int $userId) : ?float
    {
